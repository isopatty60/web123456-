	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>รายการ <b>รูปภาพ</b></h2>
					</div>
					<div class="col-sm-6">
                        <a href="/employees" class="btn btn-danger" ><i class="material-icons">&#xe3f4;</i>  <span>เพิ่มรูปภาพ</span></a>
                        <a href="/invoie" class="btn btn-primary" ><i class="material-icons">&#xE147;</i> <span>กลับหน้าหลัก</span></a>
            ...
            <div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$employee->post}}</td>
                        <th> <img src="{{ asset ('uploads/employees/' . $employee->image) }}" width="250" height="200" alt="Image"> </th>
